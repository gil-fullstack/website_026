...
const whatsappUrl = 'https://wa.me/5535984698908?text=' +
  encodeURIComponent('Olá! Gostaria de saber mais sobre os planos CIAF.')
</script>

<template>
  <section class="buy-hero" aria-labelledby="buy-hero-heading">
    <div class="buy-hero__bg-shape" aria-hidden="true" />

    <div class="container buy-hero__inner">
      <span class="buy-hero__badge">
        <i class="mdi mdi-cart-check" aria-hidden="true" />
        {{ badge }}
      </span>

      <h1 id="buy-hero-heading" class="buy-hero__title">{{ title }}</h1>
      <p class="buy-hero__desc">{{ description }}</p>

      <div class="buy-hero__actions">
      ...
      <div v-if="highlights.length" class="buy-hero__highlights">
