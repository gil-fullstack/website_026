...
const whatsappUrl = 'https://wa.me/5535984698908?text=' +
  encodeURIComponent('Olá! Quero saber mais sobre o Petsystem.')
</script>
    ...
    <div class="container product-hero__inner">
      ...
      <div class="product-hero__content">
        <span class="product-hero__badge">
          <i class="mdi mdi-paw" aria-hidden="true" />
          Gestão para Pet Shops e Clínicas Veterinárias
        </span>
      ...
      <!-- Coluna direita: preview das versões -->
      <div class="product-hero__plans-preview" aria-hidden="true">
        <p class="plans-preview__label">Versões disponíveis</p>
        <div class="plans-preview__list">
          ...
          >
            ...
            <div class="plan-chip__right">
              <span class="plan-chip__price">{{ plan.prices[0].price }}</span>
              <span class="plan-chip__period">{{ plan.prices[0].period }}</span>
        ...
        <p class="plans-preview__note">
          ...
          Valores do plano anual parcelado — outras opções de pagamento disponíveis
        </p>
      </div>
    </div>
  </section>
