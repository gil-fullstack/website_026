  ...
  <section id="planos" class="product-plans" aria-labelledby="plans-heading">
    <div class="container">
      <header class="section-header">
        <h2 id="plans-heading">Escolha a versão ideal para seu negócio</h2>
        <p>Duas versões do Petsystem, com ou sem emissão fiscal, sempre com suporte gratuito incluído.</p>
      </header>
      ...
      <div class="plans-grid" role="list">
        ...
        >
          ...
          <RouterLink
            :to="`/solucoes/petsystem/${plan.slug}`"
      ...
      <p class="plans-disclaimer">
        ...
        disponível apenas no <RouterLink to="/solucoes/petsystem/petsystem-fiscal">Petsystem Fiscal</RouterLink>.
      </p>
    </div>
  </section>
</template>
