...
function whatsappUrl(planName) {
  const msg = encodeURIComponent(`Olá! Quero contratar o CIAF Emissor — ${planName}.`)
  ...
  <section id="planos" class="product-plans" aria-labelledby="plans-heading">
    <div class="container">
      <header class="section-header">
        ...
        <p>Três opções de assinatura do CIAF Emissor, todas com suporte gratuito e até 100 emissões por mês.</p>
      </header>
      ...
      <p class="plans-disclaimer">
        ...
        O CIAF Emissor não inclui controle de estoque, módulo financeiro ou outros recursos de ERP.
        Empresas que precisam de gestão completa podem conhecer o
