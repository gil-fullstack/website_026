...
const whatsappUrl = 'https://wa.me/5535984698908?text=' +
  encodeURIComponent('Olá! Quero saber mais sobre o CIAF Emissor.')
</script>
    ...
    <div class="container product-hero__inner">
      ...
      <div class="product-hero__content">
        ...
        <div class="product-hero__trust">
          ...
          <span class="trust-item">
            <i class="mdi mdi-check-decagram-outline" aria-hidden="true" />
            Conformidade fiscal garantida
          </span>
        </div>
      </div>

      <!-- Coluna direita: preview de preços -->
      <div class="product-hero__plans-preview" aria-hidden="true">
        ...
        <p class="plans-preview__note">
          ...
          Até 100 emissões/mês em todos os planos
        </p>
      </div>
    </div>
  </section>
